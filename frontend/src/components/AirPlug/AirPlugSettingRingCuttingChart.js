...
import "./AirPlugSettingRingCuttingChart.css";
...
const AirPlugSettingRingCuttingChart = () => {
    ...
    const handlePrint = () => {
        ...
        @media print {
            ...
            .AirPlug_SettingRingCutting_data_entry__table th {
            font-size: 22px;
            }
            th.a_m_gborder {
            ...
            .AirPlug_SettingRingCutting_data_table_title_1 {
                margin-top: -5%;
            }
        }
    `;
    ...
    return (
        ...
        <div className="AirPlug_SettingRingCutting_data_entry__container">
            <div className="AirPlug_SettingRingCutting_table_container">
                {!isDateRangeSelected && (
                <div className="AirPlug_SettingRingCutting-work-order-range-container">

                        <div className="AirPlug_SettingRingCutting-work-order-range-section">
                            <button className="back-button" onClick={() => navigate(-1)}>⬅ Back</button>
                            <h2 className="AirPlug_SettingRingCutting-work-order-range-title1">Air Plug <br/>
                            Setting Ring Cutting
                                Chart</h2>
                            <h3 className="AirPlug_SettingRingCutting-work-order-range-title2">Select Work Order
                                Range</h3>
                            <div className="AirPlug_SettingRingCutting-work-order-range-inputs">
                    ...
                    <div className="AirPlug_SettingRingCutting_search-container">
                        ...
                        {isDateRangeSelected && (
                            <div>
                                ...
                                <div className="AirPlug_SettingRingCutting_table-container">
                                <button className="chart-back-button" onClick={() => navigate(-1)}>⬅ Back</button>

                                    <button onClick={handlePrint} className="AirPlug_SettingRingCutting_data_entry_button">
                                        Print Report
                                    </button>
                                    <div className="AirPlug_SettingRingCutting_data_container" ref={printRef}>
                                        <table className="AirPlug_SettingRingCutting_data_entry__table">
                                            <thead>
                                            <tr className="h-title">
                                            <img src="/LogoNew.png" style={{width: "0px"}} alt=""></img>
                                            <th colSpan="10" className="AirPlug_SettingRingCutting_data_table_title_1 title_1">
                                                    Quality Management System
                                                    <br/>
                                                    AirPlug: Setting Ring Cutting Chart
                                                </th>
                                            </tr>
                                            <tr className="t-head">
                                                ...
                                                <th className="a_m_gborder">FINISH SIZE</th>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                {shouldPrintWorkOrder && (
                                                                                    <td
                                                                                        ...
                                                                                        className={`AirPlug_SettingRingCutting_party-name-cell ${isLastEntryInParty ? 'no-bottom-border' : ''}`}
                                                                                        style={{
                                                                                    ...
                                                                                    >
                                                                                        <strong
                                                                                            className="AirPlug_SettingRingCutting_p_span">
                                                                                ...
                                                                                {!shouldPrintWorkOrder && entryIndex === 0 && (
                                                                                    <td
                                                                                        ...
                                                                                        className="AirPlug_SettingRingCutting_party-name-cells"
                                                                                        style={{
...
export default AirPlugSettingRingCuttingChart;