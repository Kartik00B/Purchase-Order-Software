...
import "./AirPlugSettingRingLappingChart.css";
...
const AirPlugSettingRingMachiningChart = () => {
    ...
    const fetchFinishSizes = async () => {
        try {
            const response = await axios.get("http://localhost:5000/calculate-IDOD");
        ...
        try {
            ...
            const finishSizeMap = finishSizes.reduce((acc, curr) => {
                acc[curr.record_sr_no] = {
                    ID: parseFloat(curr.ID).toFixed(2),
                    OD: parseFloat(curr.OD).toFixed(2),
            ...
            const mergedData = rawData.map((entry) => {
                ...
                return {
                    ...entry,
                    ID: sizeDetails.ID || "N/A",
                    OD: sizeDetails.OD || "N/A",
                    Tolerance: sizeDetails.Tolerance || "N/A",
    ...
    const handlePrint = () => {
        ...
        @media print {
            ...
            .airplug_sr_lapping_data_entry__table th {
            font-size: 22px;
            }
            th.a_s_r_l_gborder {
            ...
            .airplug_sr_lapping_data_table_title_1 {
                margin-top: -5%;
            }
        }
    `;
    ...
    return (
        ...
        <div className="airplug_sr_lapping_data_entry__container">
            <div className="airplug_sr_lapping_table_container">
                {!isDateRangeSelected && (
                <div className="airplug_sr_lapping-work-order-range-container">

                        <div className="airplug_sr_lapping-work-order-range-section">
                            <button className="back-button" onClick={() => navigate(-1)}>⬅ Back</button>
                            <h2 className="airplug_sr_lapping-work-order-range-title1">Air Plug <br/>
                            Setting Ring Machining
                                Chart</h2>
                            <h3 className="airplug_sr_lapping-work-order-range-title2">Select Work Order
                                Range</h3>
                            <div className="airplug_sr_lapping-work-order-range-inputs">
                    ...
                    <div className="airplug_sr_lapping_search-container">
                        ...
                        {isDateRangeSelected && (
                            <div>
                                ...
                                <div className="airplug_sr_lapping_table-container">
                                <button className="chart-back-button" onClick={() => navigate(-1)}>⬅ Back</button>

                                    <button onClick={handlePrint} className="airplug_sr_lapping_data_entry_button">
                                        Print Report
                                    </button>
                                    <div className="airplug_sr_lapping_data_container" ref={printRef}>
                                        <table className="airplug_sr_lapping_data_entry__table">
                                            <thead>
                                            <tr className="h-title">
                                            <img src="/LogoNew.png" style={{width: "0px"}} alt=""></img>
                                            <th colSpan="10" className="airplug_sr_lapping_data_table_title_1 title_1">
                                                    Quality Management System
                                                    <br/>
                                                    AirPlug: Setting Ring Machining Chart
                                                </th>
                                            </tr>
                                            <tr className="t-head">
                                                ...
                                                <th className="a_s_r_l_gborder">SR M/S (DIA.D -0.1)</th>
                                                <th className="a_s_r_l_gborder">O.D.</th>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                {shouldPrintWorkOrder && (
                                                                                    <td
                                                                                        ...
                                                                                        className={`airplug_sr_lapping_party-name-cell ${isLastEntryInParty ? 'no-bottom-border' : ''}`}
                                                                                        style={{
                                                                                    ...
                                                                                    >
                                                                                        <strong
                                                                                            className="airplug_sr_lapping_p_span">
                                                                                ...
                                                                                {!shouldPrintWorkOrder && entryIndex === 0 && (
                                                                                    <td
                                                                                        ...
                                                                                        className="airplug_sr_lapping_party-name-cells"
                                                                                        style={{
...
{/*                                                                                                                                                                 
                                                                                ...
                                                                                <td className="l_gborder">{entry.OD}</td>
...
export default AirPlugSettingRingMachiningChart;