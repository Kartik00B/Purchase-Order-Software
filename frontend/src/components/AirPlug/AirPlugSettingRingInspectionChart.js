...
import "./AirPlugSettingRingInspectionChart.css";
...
const AirPlugSettingRingInspectionChart = () => {
    ...
    const handlePrint = () => {
        ...
        @media print {
            ...
            .airplug_sr_inspection_data_entry__table th {
            font-size: 22px;
            }
            th.a_s_r_l_gborder {
            ...
            .airplug_sr_inspection_data_table_title_1 {
                margin-top: -5%;
            }
        }
    `;
    ...
    return (
        ...
        <div className="airplug_sr_inspection_data_entry__container">
            <div className="airplug_sr_inspection_table_container">
                {!isDateRangeSelected && (
                <div className="airplug_sr_inspection-work-order-range-container">

                        <div className="airplug_sr_inspection-work-order-range-section">
                            <button className="back-button" onClick={() => navigate(-1)}>⬅ Back</button>
                            <h2 className="airplug_sr_inspection-work-order-range-title1">Air Plug <br/>
                            Setting Ring Inspection
                                Chart</h2>
                            <h3 className="airplug_sr_inspection-work-order-range-title2">Select Work Order
                                Range</h3>
                            <div className="airplug_sr_inspection-work-order-range-inputs">
                    ...
                    <div className="airplug_sr_inspection_search-container">
                        ...
                        {isDateRangeSelected && (
                            <div>
                                ...
                                <div className="airplug_sr_inspection_table-container">
                                <button className="chart-back-button" onClick={() => navigate(-1)}>⬅ Back</button>

                                    <button onClick={handlePrint} className="airplug_sr_inspection_data_entry_button">
                                        Print Report
                                    </button>
                                    <div className="airplug_sr_inspection_data_container" ref={printRef}>
                                        <table className="airplug_sr_inspection_data_entry__table">
                                            <thead>
                                            <tr className="h-title">
                                                <img src="/LogoNew.png" style={{width: "0px"}} alt=""></img>
                                                <th colSpan="10" className="airplug_sr_inspection_data_table_title_1 title_1">
                                                    Quality Management System
                                                    <br/>
                                                    AirPlug: Setting Ring Inspection Chart
                                                </th>
                                            </tr>
                                            <tr className="t-head">
                                                ...
                                                <th className="a_s_r_l_gborder blank">TOL -/+um</th>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                {shouldPrintWorkOrder && (
                                                                                    <td
                                                                                        ...
                                                                                        className={`airplug_sr_inspection_party-name-cell ${isLastEntryInParty ? 'no-bottom-border' : ''}`}
                                                                                        style={{
                                                                                    ...
                                                                                    >
                                                                                        <strong
                                                                                            className="airplug_sr_inspection_p_span">
                                                                                ...
                                                                                {!shouldPrintWorkOrder && entryIndex === 0 && (
                                                                                    <td
                                                                                        ...
                                                                                        className="airplug_sr_inspection_party-name-cells"
                                                                                        style={{
                                                                                ...
                                                                                <td className="l_gborder">{entry.Tolerance}</td>
...
export default AirPlugSettingRingInspectionChart;