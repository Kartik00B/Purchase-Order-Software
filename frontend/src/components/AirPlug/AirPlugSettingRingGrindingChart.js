...
import "./AirPlugSettingRingGrindingChart.css";
...
const AirPlugSettingRingGrindingChart = () => {
    ...
    const handlePrint = () => {
        ...
        @media print {
            ...
            .airplug_sr_grinding_data_entry__table th {
            font-size: 22px;
            }
            th.a_s_r_l_gborder {
            ...
            .airplug_sr_grinding_data_table_title_1 {
                margin-top: -5%;
            }
        }
    `;
    ...
    return (
        ...
        <div className="airplug_sr_grinding_data_entry__container">
            <div className="airplug_sr_grinding_table_container">
                {!isDateRangeSelected && (
                <div className="airplug_sr_grinding-work-order-range-container">

                        <div className="airplug_sr_grinding-work-order-range-section">
                            <button className="back-button" onClick={() => navigate(-1)}>⬅ Back</button>
                            <h2 className="airplug_sr_grinding-work-order-range-title1">Air Plug <br/>
                            Setting Ring Grinding
                                Chart</h2>
                            <h3 className="airplug_sr_grinding-work-order-range-title2">Select Work Order
                                Range</h3>
                            <div className="airplug_sr_grinding-work-order-range-inputs">
                    ...
                    <div className="airplug_sr_grinding_search-container">
                        ...
                        {isDateRangeSelected && (
                            <div>
                                ...
                                <div className="airplug_sr_grinding_table-container">
                                <button className="chart-back-button" onClick={() => navigate(-1)}>⬅ Back</button>

                                    <button onClick={handlePrint} className="airplug_sr_grinding_data_entry_button">
                                        Print Report
                                    </button>
                                    <div className="airplug_sr_grinding_data_container" ref={printRef}>
                                        <table className="airplug_sr_grinding_data_entry__table">
                                            <thead>
                                            <tr className="h-title">
                                            <img src="/LogoNew.png" style={{width: "0px"}} alt=""></img>
                                            <th colSpan="10" className="airplug_sr_grinding_data_table_title_1 title_1">
                                                    Quality Management System
                                                    <br/>
                                                    AirPlug: Setting Ring Grinding Chart
                                                </th>
                                            </tr>
                                            <tr className="t-head">
                                                                            ...
                                                                            >
                                                                                ...
                                                                                {shouldPrintWorkOrder && (
                                                                                    <td
                                                                                        ...
                                                                                        className={`airplug_sr_grinding_party-name-cell ${isLastEntryInParty ? 'no-bottom-border' : ''}`}
                                                                                        style={{
                                                                                    ...
                                                                                    >
                                                                                        <strong
                                                                                            className="airplug_sr_grinding_p_span">
                                                                                ...
                                                                                {!shouldPrintWorkOrder && entryIndex === 0 && (
                                                                                    <td
                                                                                        ...
                                                                                        className="airplug_sr_grinding_party-name-cells"
                                                                                        style={{
...
export default AirPlugSettingRingGrindingChart;