...
import "./AirRingSettingPlugSettingDiscInspectionChart.css";
import 'font-awesome/css/font-awesome.min.css';
import {QRCodeSVG} from "qrcode.react";
import BASE_URL from "../config";
import {useNavigate, useParams} from "react-router-dom";

const AirRingSettingPlugSettingDiscInspectionChart = () => {
...
// Fetch and organize AirRing data
    ...
    return (
        <div className="ar_spd_inspection_data_entry__container">
            <div className="ar_spd_inspection_table_container">
                <div className="machining-work-order-range-container">
                    ...
                    <div className="ar_spd_inspection_search-container">
                        ...
                        {isDateRangeSelected && (
                            <div>
                                ...
                                />
                                <div className="ar_spd_inspection_table-container">                            
                                    ...
                                    <div className="ar_spd_inspection_data_container" ref={printRef}>
                                        <table className="ar_spd_inspection_data_entry__table">
                                            <thead>
                                            <tr className="h-title">
                                            <img src="/LogoNew.png" style={{width: "0px"}} alt=""></img>
                                            <th colSpan="11"
                                                    className="ar_spd_inspection_data_table_title_1 title_1">
                                                                        ...
                                                                        return (
                                                                            <tr
                                                                                ...
                                                                                {shouldPrintWorkOrder && (
                                                                                    ...
                                                                                    className={`ar_spd_inspection_party-name-cell ${isLastEntryInParty ? 'no-bottom-border' : ''}`}
                                                                                    style={{
                                                                                        ...
                                                                                        >
                                                                                        <strong
                                                                                            className="ar_spd_inspection_p_span">
                                                                                ...
                                                                                {!shouldPrintWorkOrder && entryIndex === 0 && (
                                                                                    <td
                                                                                        ...
                                                                                        className="ar_spd_inspection_party-name-cells"
                                                                                        style={{
...
export default AirRingSettingPlugSettingDiscInspectionChart;  