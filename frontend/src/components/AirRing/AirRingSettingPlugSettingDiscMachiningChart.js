...
import "./AirRingSettingPlugSettingDiscMachiningChart.css";
import 'font-awesome/css/font-awesome.min.css';
import {QRCodeSVG} from "qrcode.react";
import BASE_URL from "../config";
import {useNavigate, useParams} from "react-router-dom";

const AirRingSettingPlugSettingDiscMachiningChart = () => {
...
// Fetch and organize AirRing data
        ...
        try {
            ...
            const internalDiameterMap = internalDiameters.reduce((acc, curr) => {
                acc[curr.record_sr_no] = {
                    settingPlugSize: parseFloat(curr.settingPlugSize).toFixed(1),
                    range: (curr.range),
            ...
            const mergedData = rawData.map((entry) => {
                ...
                return {
                    ...entry,
                    settingPlugSize: sizeDetails.settingPlugSize || "N/A",
                    range: sizeDetails.range || "N/A",
    ...
    return (
        <div className="airring_machining_data_entry__container">
            <div className="airring_machining_table_container">
                <div className="machining-work-order-range-container">
                    {!isDateRangeSelected && (
                        <div className="machining-work-order-range-section">
                            ...
                            <h2 className="machining-work-order-range-title1">Air Ring
                                <br />
                                Setting Plug and Setting Disc : Machining Chart
                                Chart</h2>
                    ...
                    <div className="airring_machining_search-container">
                        ...
                        {isDateRangeSelected && (
                            <div>
                                ...
                                <div className="airring_machining_table-container">                            
                                    ...
                                    <div className="airring_machining_data_container" ref={printRef}>
                                        <table className="airring_machining_data_entry__table">
                                            <thead>
                                            <tr className="h-title">
                                            <img src="/LogoNew.png" style={{width: "0px"}} alt=""></img>
                                            <th colSpan="10"
                                                    className="airring_machining_data_table_title_1 title_1">
                                                    Quality Management System
                                                    <br/>
                                                    Setting Plug and Setting Disc:<br /> Machining Chart                                                </th>
                                            </tr>
                                            <tr className="t-head">
                                                <th className="gborder blank work">Work Order No</th>
                                                <th className="gborder">SUB SR NO.</th>
                                                <th className="gborder">QTY</th>
                                                <th className="gborder Id">SETTING PLUG</th>
                                                <th className="gborder">RANGE</th>
                                                {/* <th className="gborder">FINISH OD</th> */}
                                                                            ...
                                                                            >
                                                                                ...
                                                                                {shouldPrintWorkOrder && (
                                                                                    <td
                                                                                        ...
                                                                                        className={`airring_machining_party-name-cell ${isLastEntryInParty ? 'no-bottom-border' : ''}`}
                                                                                        style={{
                                                                                    ...
                                                                                    >
                                                                                        <strong
                                                                                            className="airring_machining_p_span">
                                                                                ...
                                                                                {!shouldPrintWorkOrder && entryIndex === 0 && (
                                                                                    <td
                                                                                        ...
                                                                                        className="airring_machining_party-name-cells"
                                                                                        style={{
                                                                                ...
                                                                                {/*	<br/>*/}
                                                                                {/*	<strong>*/}
                                                                                {/*		TOL: {entry.size_low_bore_size} / {entry.size_high_bore_size}*/}
                                                                                {/*	</strong>*/}
                                                                                {/*	<br/>*/}
                                                                                ...
                                                                                {/*<td className="gborder">{entry.qty}</td>*/}
                                                                                <td className="gborder Id">{entry.settingPlugSize}</td>
                                                                                {/*<td className="gborder">{entry.bore_size}</td>*/}
                                                                                <td className="gborder blank">{entry.range}</td>
                                                                                {/* <td className="gborder">{entry.finish_od}</td> */}
                                                                                ...
                                                                                {/*<td className="gborder">{entry.runits}</td>*/}
...
export default AirRingSettingPlugSettingDiscMachiningChart;