...
import "./AirRingMachiningChart.css";
import 'font-awesome/css/font-awesome.min.css';
import {QRCodeSVG} from "qrcode.react";
import BASE_URL from "../config";
import {useNavigate, useParams} from "react-router-dom";

const AirRingMachiningChart = () => {
        ...
        try {
            ...
            const internalDiameterMap = internalDiameters.reduce((acc, curr) => {
                acc[curr.record_sr_no] = {
                    ...
                    finish_thickness: curr.finish_thickness,
                    finish_od: curr.finish_od,
            ...
            const mergedData = rawData.map((entry) => {
                ...
                return {
                    ...
                    finish_thickness: sizeDetails.finish_thickness || "N/A",
                    finish_od: sizeDetails.finish_od || "N/A",
                                    ...
                                    <div className="airring_machining_data_container" ref={printRef}>
                                        <table className="airring_machining_data_entry__table">
                                            ...
                                            <tr className="t-head">
                                                ...
                                                <th className="gborder">F. THICKNESS</th>
                                                                    ...
                                                                    return entries.map((entry, entryIndex) => {
                                                                        ...
                                                                        return (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <td className="gborder blank">{entry.FinishSize}</td>
                                                                                <td className="gborder blank">{entry.finish_thickness}</td>
...
export default AirRingMachiningChart;