...
import "./AirRingLappingChart.css";
import 'font-awesome/css/font-awesome.min.css';
import {QRCodeSVG} from "qrcode.react";
import BASE_URL from "../config";
import {useNavigate, useParams} from "react-router-dom";

const AirRingLappingChart = () => {
    const {component} = useParams();
    const [airRingLappingData, setAirRingLappingData] = useState([]);
...
// Fetch and organize AirRing data
    const fetchDailyData = useCallback(async (fromWorkOrderNo, toWorkOrderNo) => {
        try {
            ...
            setAirRingLappingData(dataArray);
    ...
    const handleSearch = (e) => {
        ...
        if (query === "") {
            setFilteredData(airRingLappingData);
        } else {
            setFilteredData(
                airRingLappingData.filter((entry) =>
    ...
    return (
        <div className="airring_lapping_data_entry__container">
            <div className="airring_lapping_table_container">
                <div className="lapping-work-order-range-container">
                    {!isDateRangeSelected && (
                        <div className="lapping-work-order-range-section">
                            <button className="back-button" onClick={() => navigate(-1)}>⬅ Back</button>

                            <h2 className="lapping-work-order-range-title1">Air Ring
                                Lapping
                                Chart</h2>
                            <h3 className="lapping-work-order-range-title2">Select Work Order
                                Range</h3>
                            <div className="lapping-work-order-range-inputs">
                    ...
                    <div className="airring_lapping_search-container">
                        ...
                        {isDateRangeSelected && (
                            <div>
                                ...
                                <div className="airring_lapping_table-container">
                                <button className="chart-back-button" onClick={() => navigate(-1)}>⬅ Back</button>

                                    <button onClick={handlePrint} className="lapping_data_entry_button">
                                        Print Report
                                    </button>
                                    <div className="airring_lapping_data_container" ref={printRef}>
                                        <table className="airring_lapping_data_entry__table">
                                            <thead>
                                            <tr className="h-title">
                                            <img src="/LogoNew.png" style={{width: "0px"}} alt=""></img>

                                                <th colSpan="14"
                                                    className="airring_lapping_data_table_title_1 title_1">
                                                    Quality Management System
                                                    <br/>
                                                    AirRing: Lapping Chart
                                                </th>
                                            </tr>
                                            <tr className="t-head">
                                                                            ...
                                                                            >
                                                                                ...
                                                                                {shouldPrintWorkOrder && (
                                                                                    <td
                                                                                        ...
                                                                                        className={`airring_lapping_party-name-cell ${isLastEntryInParty ? 'no-bottom-border' : ''}`}
                                                                                        style={{
                                                                                    ...
                                                                                    >
                                                                                        <strong
                                                                                            className="airring_lapping_p_span">
                                                                                ...
                                                                                {!shouldPrintWorkOrder && entryIndex === 0 && (
                                                                                    <td
                                                                                        ...
                                                                                        className="airring_lapping_party-name-cells"
                                                                                        style={{
...
export default AirRingLappingChart;