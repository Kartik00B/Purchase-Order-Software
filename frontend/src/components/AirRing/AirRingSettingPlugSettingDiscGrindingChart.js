...
import "./AirRingSettingPlugSettingDiscGrindingChart.css";
import 'font-awesome/css/font-awesome.min.css';
import {QRCodeSVG} from "qrcode.react";
import BASE_URL from "../config";
import {useNavigate, useParams} from "react-router-dom";

const AirRingSettingPlugSettingDiscGrindingChart = () => {
...
// Fetch and organize AirRing data
    ...
    return (
        <div className="ar_spd_grinding_data_entry__container">
            <div className="ar_spd_grinding_table_container">
                <div className="machining-work-order-range-container">
                    {!isDateRangeSelected && (
                        <div className="machining-work-order-range-section">
                            ...
                            <h2 className="machining-work-order-range-title1">Air Ring
                                <br />
                                Setting Plug and Setting Disc : Grinding Chart
                                Chart</h2>
                    ...
                    <div className="ar_spd_grinding_search-container">
                        ...
                        {isDateRangeSelected && (
                            <div>
                                ...
                                />
                                <div className="ar_spd_grinding_table-container">                            
                                    ...
                                    <div className="ar_spd_grinding_data_container" ref={printRef}>
                                        <table className="ar_spd_grinding_data_entry__table">
                                            <thead>
                                            <tr className="h-title">
                                            <img src="/LogoNew.png" style={{width: "0px"}} alt=""></img>
                                            <th colSpan="11"
                                                    className="ar_spd_grinding_data_table_title_1 title_1">
                                                    {/* Quality Management System */}
                                                    {/* <br/> */}
                                                    Setting Plug & Setting Disc:<br /> Grinding Chart                                                </th>
                                            </tr>
                                            <tr className="t-head">
                                                ...
                                                <th className="gborder">ALLOWANCE</th>
                                                                        ...
                                                                        return (
                                                                            <tr
                                                                                ...
                                                                                {shouldPrintWorkOrder && (
                                                                                    ...
                                                                                    className={`ar_spd_grinding_party-name-cell ${isLastEntryInParty ? 'no-bottom-border' : ''}`}
                                                                                    style={{
                                                                                        ...
                                                                                        >
                                                                                        <strong
                                                                                            className="ar_spd_grinding_p_span">
                                                                                ...
                                                                                {!shouldPrintWorkOrder && entryIndex === 0 && (
                                                                                    <td
                                                                                        ...
                                                                                        className="ar_spd_grinding_party-name-cells"
                                                                                        style={{
                                                                                ...
                                                                                <td className="gborder">{entry.allowance}</td>
...
export default AirRingSettingPlugSettingDiscGrindingChart;  