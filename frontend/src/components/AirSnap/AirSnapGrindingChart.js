...
import "./AirSnapGrindingChart.css";
import 'font-awesome/css/font-awesome.min.css';
import {QRCodeSVG} from 'qrcode.react';
import BASE_URL from "../config";
import {useNavigate, useParams} from "react-router-dom";

const AirSnapGrindingChart = () => {
        ...
        try {
            ...
            const finishSizeMap = finishSizes.reduce((acc, curr) => {
                acc[curr.record_sr_no] = {
                    Nominal: parseFloat(curr.Nominal).toFixed(4),
                    Low: parseFloat(curr.Low).toFixed(4),
                    High: parseFloat(curr.High).toFixed(4),
                    codes: curr.codes,
                    Finish_size: curr.Finish_size,
                    internal_dia: parseFloat(curr.internal_dia).toFixed(4),
            ...
            const mergedData = rawData.map((entry) => {
                ...
                return {
                    ...entry,
                    Nominal: sizeDetails.Nominal || "N/A",
                    Low: sizeDetails.Low || "N/A",
                    High: sizeDetails.High || "N/A",
                    internal_dia: sizeDetails.internal_dia || "N/A",
                    codes: sizeDetails.codes || "Nn/A",
    ...
    const handlePrint = () => {
        ...
        @media print {
            ...
            .airsnap_grinding_data_entry__table th {
            font-size: 22px;
            }
            th.a_s_r_l_gborder {
            ...
            .airsnap_grinding_data_table_title_1 {
                margin-top: -5%;
            }
        }
    `;
    ...
    return (
        ...
        <div className="airsnap_grinding_data_entry__container">
            <div className="airsnap_grinding_table_container">
                {!isDateRangeSelected && (
                <div className="airsnap_grinding-work-order-range-container">

                        <div className="airsnap_grinding-work-order-range-section">
                            <button className="back-button" onClick={() => navigate(-1)}>⬅ Back</button>
                            <h2 className="airsnap_grinding-work-order-range-title1">Air Snap <br /> Grinding Chart</h2>
                            <h3 className="airsnap_grinding-work-order-range-title2">Select Work Order
                                Range</h3>
                            <div className="airsnap_grinding-work-order-range-inputs">
                    ...
                    <div className="airsnap_grinding_search-container">
                        ...
                        {isDateRangeSelected && (
                            <div>
                                ...
                                <div className="airsnap_grinding_table-container">
                                <button className="chart-back-button" onClick={() => navigate(-1)}>⬅ Back</button>

                                    <button onClick={handlePrint} className="airsnap_grinding_data_entry_button">
                                        Print Report
                                    </button>
                                    <div className="airsnap_grinding_data_container" ref={printRef}>
                                        <table className="airsnap_grinding_data_entry__table">
                                            <thead>
                                            <tr className="h-title">
                                            <img src="/LogoNew.png" style={{width: "0px"}} alt=""></img>
                                            <th colSpan="15" className="airsnap_grinding_data_table_title_1 title_1">
                                                    Quality Management System
                                                    <br/>
                                                    AirSnap: Grinding Chart
                                                </th>
                                            </tr>
                                            <tr className="t-head">
                                                ...
                                                <th className="a_s_r_l_gborder">UNITS</th>
                                                <th className="a_s_r_l_gborder blank">JET TYPE</th>
                                                <th className="a_s_r_l_gborder">ID</th>
                                                <th className="a_s_r_l_gborder">REMARK</th>
                                                <th className="a_s_r_l_gborder lblank">COMPLETE DATE</th>
                                                <th className="a_s_r_l_gborder">T. DISPATCH DATE</th>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                {shouldPrintWorkOrder && (
                                                                                    <td
                                                                                        ...
                                                                                        className={`airsnap_grinding_party-name-cell ${isLastEntryInParty ? 'no-bottom-border' : ''}`}
                                                                                        style={{
                                                                                    ...
                                                                                    >
                                                                                        <strong
                                                                                            className="airsnap_grinding_p_span">
                                                                                ...
                                                                                {!shouldPrintWorkOrder && entryIndex === 0 && (
                                                                                    <td
                                                                                        ...
                                                                                        className="airsnap_grinding_party-name-cells"
                                                                                        style={{
                                                                                ...
                                                                                <td className="u_gborder">{entry.codes}</td>
                                                                                <td className="l_gborder">{entry.bore_jet_type}</td>
                                                                                <td className="i_gborder">{entry.internal_dia}</td>
                                                                                <td className="i_gborder">{entry.remark}</td>
...
export default AirSnapGrindingChart;